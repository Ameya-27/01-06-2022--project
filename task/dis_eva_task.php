                                ...
                                <div class="col-md-7 col-lg-11 m-h-auto">
                                    <div class="card shadow-lg">
                                        <div class="card-body">
                                            ...
                                            <h2 style="text-align:center; color:rgb(52, 140, 181);"> Evaluation By Manager</h2>
                                            <form action="employee_manager_insert.php" method="POST" >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-affix">
                                                        ...
                                                        <input type="text" class="form-control" id="desc" name="desc" placeholder="task_eval" required readonly value="
                                                    <?php
                                ...
                                <div class="col-md-7 col-lg-11 m-h-auto">
                                    <div class="card shadow-lg">
                                        <div class="card-body">
                                            ...
                                            <h2 style="text-align:center; color:rgb(52, 140, 181);"> Self Evaluation</h2>
                                            <div>
